...
var preferredNewEmailMethod = 'mailto';
var customSearchUrl;
                ...
                if (convertWhenOnlyFewWordsSelected == false || wordsCount <= wordsLimitToProccessText) {
                  ...
                  if (showEmailButton && selectedText.includes('@') && !selectedText.trim().includes(' ')) {
                    try {
                      ...
                      if (addButtonIcons)
                        emailButton.innerHTML = createImageIcon(emailButtonIcon, 0.7) + (emailText.length > linkSymbolsToShow ? emailText.substring(0, linkSymbolsToShow) + '...' : emailText);
                      else
  ...
  if (draggableTooltip) {
    ...
    arrowChild.onmousedown = function (e) {
      ...
      document.onmousemove = function (e) {
        ...
        /// More performant 'transform' approach
...
function hideTooltip() {
  ...
  if (debugMode) {
    console.log(`Found ${oldTooltips.length} tooltips:`);
